    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        ...
        */
        ...
        <h1 class="h2">Doenças</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
        <a class="btn btn-sm btn-outline-primary" href="/lab-eng-web/new-diseases">Nova Doença</a>
        </div>
        </div>
        </div>
